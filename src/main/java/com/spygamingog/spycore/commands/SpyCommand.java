                ...
                if (args.length > 3) {
                    ...
                    if (registeredPath != null) {
                        ...
                        if (targetFile.exists() && targetFile.isDirectory()) {
                             // Check if it is a container (has subdirs) and NOT a world (no level.dat)
                             ...
                             if (!hasLevelDat && hasSubDirs) {
                                 sender.sendMessage("§cError: '" + lastArg + "' is a container, not a world.");
                                 return;
                             }
